/*
  ...
  - You are about to alter the column `expireTime` on the `PasswordResetToken` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
